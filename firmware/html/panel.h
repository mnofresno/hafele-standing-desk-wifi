...
<head>
    ...
    <style>
        ...
        .moving-robot-icon::before {
            content: "\1F916 \1F4A8"; /* Unicode character for robot face and dash symbol */
...
<body>
    ...
    <script>
        ...
        function set_status_icon_moving() {
            messageSpan.classList.add('moving-robot-icon'); // Añadir clase de robot en movimiento
            messageSpan.classList.remove('ruler-icon'); // Quitar clase de icono de regla
        }
        function set_status_icon_ruler() {
            messageSpan.classList.remove('moving-robot-icon'); // Quitar clase de robot en movimiento
            messageSpan.classList.add('ruler-icon'); // Restaurar clase de icono de regla
        }
